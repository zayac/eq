...
\newcommand{\BnfDocumentClass}{
\bHead{documentclass}
  \bToken{\bs documentclass} \bSymb{\{} \bSpecial{num} \bSpecial{id} \bSymb{,}
  \bSpecial{id} \bSymb{\}} \bSymb{\{}
  \bSpecial{id} \bSymb{\}}
\bEnd
}

\newcommand{\BnfUsePackage}{
\bHead{usepackage}
  \bToken{\bs usepackage} \bSymb{\{} \bSpecial{id} \bSymb{\}}
\bEnd
}

\newcommand{\BnfBeginDocument}{
\bHead{begindocument}
  \bToken{\bs begin} \bSymb{\{} \bToken{document} \bSymb{\}}
\bEnd
}
...
\newcommand{\BnfFooter}{
\bHead{footer}
  \bToken{\bs end} \bSymb{\{} \bToken{document} \bSymb{\}}
\bEnd
}
...
\newcommand{\BnfIdx}{
\bHead{idx}
  \bSpecial{id} \bOpt{upper} \bOpt{lower}
\bEnd
}

\newcommand{\BnfUpper}{
\bHead{upper}
  \bSymb{\^} \bSymb{\{} \bOpt{\bAlt{\bSymb{[} linear \bSymb{]}}{linear}} \bSymb{\}}
\bEnd
}

\newcommand{\BnfLinear}{
\bHead{linear}
 \bSpecial{id} \bOpt{\bAlt{\bSymb{+}}{\bSymb{-}} \bSpecial{num}}
\bEnd
}

\newcommand{\BnfLower}{
\bHead{lower}
  \bSymb{\_} \bSymb{\{} expr \bStar{\bSymb{,} expr} \bSymb{\}}
\bEnd
}
...
\bHead{function\_call}
  ...
  \bStar{\bSymb{,} id }} \bSymb{\}}
\bEnd
}

\newcommand{\BnfSExpr}{
\bHead{sexpr}
  \bAltBegin \bSpecial{idx} \bDAlt \bSpecial{num} \bDAlt function\_call \bAltEnd
  \bStar{\bAlt{binop}{boolop} \bSkip \bAltBegin \bSpecial{idx} \bDAlt \bSpecial{num}
  \bDAlt function\_call \bAltEnd}
\bEnd
}
