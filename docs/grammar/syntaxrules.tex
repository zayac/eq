...
\newcommand{\BnfExpr}{
\bHead{expr}
  \bAltBegin sexpr \bDAlt filter \bDAlt genarray \bDAlt vector \bDAlt matrix
  \bAltEnd indexes
\bEnd
}
...
\bHead{generator}
  ...
  \bSpecial{id} \bStar{ \bSymb{,} \bSpecial{id}} \bSymb{:} expr \bPlus{comp
  expr} \bSkip \bStar{set\_op expr \bPlus{comp expr}}
\bEnd
}
