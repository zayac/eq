...
\bHead{ext\_type}
  type \bOpt{\bSymb{\^} \bSymb{\{} sexpr \bSymb{\}} \bSkip \bOpt{\bSymb{\_}
  \bSymb{\{} sexpr \bStar{\bSymb{,}
  sexpr} \bSymb{\}}}}
\bEnd
}
...
\bHead{filter}
  ...
  \bSpecial{\}}} \bSkip \bSymb{|} condition \bSymb{\}}
\bEnd
}
...
\bHead{with\_loop\_wbr}
  idx \bSymb{|} condition \bSymb{=} \bSkip
  \bToken{\bs begin} \bSymb{\{} \bToken{cases} \bSymb{\}} \bSkip
  \bPlus{expr \bSymb{\&} condition} \bSkip
...
\bHead{with\_loop\_wobr}
  idx \bSymb{|} condition \bSymb{=} expr
\bEnd
}
...
\newcommand{\BnfCondition}{
\bHead{condition}
  \bToken{\bs forall} \bSpecial{id} \bOr
