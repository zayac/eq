...
\newcommand{\BnfHeader}{
\bHead{header}
  \bToken{\bs documenttype} \bSymb{\{} \bSpecial{str} \bSymb{\}} \bSymb{\{}
  \bSpecial{str} \bSymb{\}} \bSkip
  \bToken{\bs usepackage} \bSymb{\{} \bSpecial{str} \bSymb{\}} \bSkip
...
\newcommand{\BnfUpper}{
\bHead{upper}
  \bSymb{\^} \bSymb{\{} \bOpt{\bSpecial{id} \bOpt{\bAlt{\bSymb{+}}{\bSymb{-}}
  \bSpecial{num}} \bSymb{\}}}
\bEnd
}
...
\newcommand{\BnfMatrix}{
\bHead{matrix}
  \bToken{\bs begin} \bSymb{\{} \bToken{ttmatrix} \bSymb{\}}\bSymb{\{}
  \bPlus{\bToken{c}} \bSymb{\}} \bSkip
