...
\begin{document}
\begin{eqcode}{advance}{p, v, m, dt}{\arraytype{5,3}{R}, \arraytype{5,3}{R},
\arraytype{5}{R}, \type{R}}{\arraytype{\ldots,\ldots,\ldots}{R}}
...
\begin{eqcode}{energy}{p, v, m}{\arraytype{5,3}{R},
    \arraytype{5,3}{R}, \arraytype{5}{R}}{\type{R}}
    e \in \type{R} \lend
...
\begin{eqcode}{offset\_momentum}{v, m}{\arraytype{5,3}{R},
\arraytype{1}{R}}{\arraytype{5,3}{R}}
...
\begin{eqcode}{main}{\ }{\ }{\type{Z}}
    p \in \arraytype{5,3}{R};
    v \in \arraytype{5,3}{R};
    m \in \arraytype{5}{R} \lend
