...
\begin{eqcode}{abs}{a}{\type{R}}{\type{Z}}

\end{eqcode}

\begin{eqcode}{sin}{a}{\type{R}}{\type{R}}
...
\begin{eqcode}{log}{a, b}{\type{R}, \type{R}}{\type{Z}}

\end{eqcode}

\begin{eqcode}{real2int}{a}{\type{R}}{\type{Z}}

\end{eqcode}

\begin{eqcode}{bool2int}{a}{\type{B}}{\type{Z}}

\end{eqcode}

\begin{eqcode}{int2bool}{a}{\type{Z}}{\type{B}}

\end{eqcode}

\begin{eqcode}{shape}{a}{\type{Z}}{\type{Z}^1}

\end{eqcode}

\begin{eqcode}{shape2}{a}{\type{Z}^1}{\type{Z}^1}
...
\begin{eqcode}{length}{a}{\type{Z}}{\type{Z}^1_8}
    ...
    n^{[0]} \gets n \lend
    r^{[i]}_i \gets \call{real2int}{\dfrac{a}{n^{[i]}}} \lend
    n^{[i]} \gets \dfrac{n^{[i-1]}}{256} \lend
    \return{\filter { r^{[i]}\  |\  i : i = {\call{shape}{a}}_0}} \lend
\end{eqcode}

\begin{eqcode}{divide}{w}{\type{Z}^1}{\type{Z}^1_{64}}
    l \gets \call{length}{\call{shape2}{w}_0} \lend
    a \in \type{Z}^1_64 \lend
    a_i\   |  i : 0 \leq i \leq 63\ \gets
        \begin{cases}
            w_i & i : i \leq \call{shape2}{w}_0 \lend
            \hex{80}  & i : i = \call{shape2}{w}_0 \lend
...
\begin{eqcode}{F}{i, x, y, z}{\type{Z}, \type{B}, \type{B},
\type{B}}{\type{B}}
    \qif {i < 16}  
...
\type{Z}^1_{16}}{\type{Z}^1_4}
    W_a \gets W_b + {W_a + X_k + \call{T}{i+1}  +
    \call{bool2int}{
    \call{F}{i,\call{int2bool}{b},\call{int2bool}{c},\call{int2bool}{d \ll
    s}}}} \lend
    \return{W} \lend
\end{eqcode}
...
\begin{eqcode}{transform\_back}{a}{\type{Z}^1_4}{\type{Z}^1_{16}}
    r \in \type{Z}^1_{16} \lend
    r_i\  |\  i: 0 \leq i \leq 15 \gets \call{real2int}{\dfrac{a_{\call{real2int}{\frac{i}{4}}}}{2^{8 \cdot
    (3 - \call{real2int}{\frac{i}{4}})}} \mod 2^{8 \cdot (4 -
    \call{real2int}{\frac{i}{4}})}} \lend
    \return{r} \lend
\end{eqcode}
%
