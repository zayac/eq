...
\bHead{let}
  ...
  expr\_ap \bOr
  expr\_with \bOr
  \bSpecial{id} \bSymb{++} \bOr
  \bSymb{++} \bSpecial{id} \bOr
  \bSpecial{id} \bSymb{--} \bOr
  \bSymb{--} \bSpecial{id} \bOr
  \bSpecial{id} \bSymb{+=} expr \bOr
  \bSpecial{id} \bSymb{-=} expr \bOr
  \bSpecial{id} \bSymb{*=} expr \bOr
  \bSpecial{id} \bSymb{/=} expr \bOr
  \bSpecial{id} \bSymb{\%=} expr
\bEnd
}
...
\newcommand{\BnfWith}{
\bHead{with}
  \bSymb{(} generator \bSymb{)} \bOpt{\bSymb{[} \bPlus{statement} \bSymb{]}} withop \bOr
  \bSymb{(} \bSpecial{id} \bSymb{)} \bPlus{part} nwithop \bOr
  \bOpt{\bSymb{\{} \bOpt{hash\_pragma \bToken{wlcomp} expr\_ap}
...
\newcommand{\BnfPart}{
  \bHead{part}
    \bSymb{(} generator \bSymb{)} \bOpt{\{ \bStar{statement} \}} \bOpt{ \bSymb{:}
    exprs }
    \bSymb{;}
\bEnd
}
...
\newcommand{\BnfNPart}{
  \bHead{npart}
    part \bOr
    \bSymb{(} generator \bSymb{)} \bOpt{\{ \bStar{statement} \}} \bSymb{:} \bSkip \bSymb{(} expr \bSymb{,} exprs \bSymb{)} \bSymb{;}
 \bEnd
}
...
\bHead{withop}
  ...
  \bToken{modarray} \bSymb{(} expr \bSymb{,} \bSpecial{id} \bSymb{,} expr
  \bSymb{]} \bOr
